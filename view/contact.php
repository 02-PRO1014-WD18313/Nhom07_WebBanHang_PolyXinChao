        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="Chủ thể"
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="bg-light p-30 mb-3">
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>123 Trịnh Văn Bô, Nam từ liêm, Hà Nội</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>info@example.com</p>
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+0966694210</p>
                </div>
            </div>
        </div>
    </div>