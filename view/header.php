                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="index.php" class="nav-item nav-link">Sản phẩm</a>
        ...
        <div class="row px-xl-5">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">ĐỒNG GIÁ SIZE L 25k</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Như Hoàng đã nói uống là mê phê tới già</p>
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">ĐỒNG GIÁ SIZE L 25k</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">uống là mê phê tới già</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="#">MUA NGAY</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="view/img/offer-1.png" alt="">
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Save 20%</h6>
                        <h3 class="text-white mb-3">ĐỒNG GIÁ SIZE L 25k</h3>
                ...
                <div class="product-offer mb-30" style="height: 200px;">
                    ...
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Save 20%</h6>
                        <h3 class="text-white mb-3">SANE PHẨM MỚI</h3>
                        <a href="" class="btn btn-primary">Shop Now</a>
                    </div>
                </div>
            </div>
