...
<div class="container py-4">
    <div class="row2">
        ...
        <hr>
        <form action="index.php?act=updatetp" method="POST">
            <div class="form-group">
                <label>Tên loại</label> <br>
                <input type="text" class="form-control" name="tentp"  value="<?php if (isset($name) && ($name != "")) echo $name; ?>">
            </div>
            <div class="form-group">
                <label>Giá</label> <br>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="total"  value="<?php if (isset($total) && ($total != "")) echo $total; ?>">
            </div>
            <div class="form-group">
